...
const PAIN_LEXICON = [
  ...
  { v: 8, label: 'Très forte', short: 'Difficile de rester relâché.', cue: 'La douleur rend le mouvement difficile à maintenir normalement.', behav: 'Tu ralentis ou tu t\'arrêtes spontanément.', official: 'Le score devient prioritaire à remonter au physio.', cues: ['Tu es tendu ou sur la défensive.', 'Le mouvement se dégrade ou s\'arrête plus vite.', 'Tu ne cherches pas à pousser à travers.'], qualities: ['coupant', 'brûlant', 'écrasant'], anchor: 'Mon repère : je protège la hanche et je perds le contrôle du geste.' },
    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 8 }}>
        <div style={{ fontFamily: T.sans, fontSize: 14, fontWeight: 500, color: T.ink, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', flex: 1, minWidth: 0 }}>
          {isPain ? 'Douleur à la hanche' : 'Effort ressenti'}
        </div>
