...
const LEXIQUE_TERMS = [
  {
    id: 'lca', term: 'LCA', long: 'Ligament croisé antérieur',
    category: 'Anatomie', phase: 'all', relevant: true,
    short: 'Ligament au centre du genou qui empêche le tibia d\'avancer trop par rapport au fémur.',
    full: 'Le ligament croisé antérieur stabilise le genou lors des mouvements de pivot et d\'arrêt brusque. Sa rupture est fréquente en sport de contact ou de pivot (ski, soccer, basket). La reconstruction chirurgicale utilise généralement un greffon prélevé sur les ischio-jambiers ou le tendon rotulien.',
    related: ['greffon', 'pivot-shift', 'proprioception'],
    important: true,
  },
  {
    id: 'greffon', term: 'Greffon', long: 'Greffon tendineux',
    category: 'Chirurgie', phase: 'early',
    short: 'Tendon prélevé pour reconstruire un ligament rompu.',
    full: 'Tissu tendineux prélevé sur ton propre corps (autogreffe) ou d\'un donneur (allogreffe) pour reconstruire le LCA. Les sites de prélèvement les plus courants sont les ischio-jambiers, le tendon rotulien ou le quadriceps. La maturation complète du greffon prend 12 à 18 mois.',
    related: ['lca', 'ischio'],
  },
  {
    ...
    full: 'Capacité du système nerveux à percevoir la position et le mouvement des articulations sans regarder. Après une chirurgie du LCA, la proprioception est altérée. Les exercices d\'équilibre (sur un pied, sur surface instable) la réentraînent. C\'est un facteur clé pour éviter une nouvelle blessure.',
    related: ['equilibre', 'lca'],
    important: true,
  },
  {
    id: 'quadriceps', term: 'Quadriceps',
    category: 'Anatomie', phase: 'all', relevant: true,
    short: 'Le grand muscle à l\'avant de la cuisse.',
    full: 'Composé de quatre chefs musculaires, le quadriceps étend le genou. Après une chirurgie, il s\'atrophie rapidement (30% de force perdue en 2 semaines). Sa réactivation est la priorité de la phase 1 de rééducation.',
    related: ['atrophie', 'extension'],
  },
  {
    id: 'ischio', term: 'Ischio-jambiers',
    category: 'Anatomie', phase: 'all',
    short: 'Les muscles à l\'arrière de la cuisse.',
    full: 'Trois muscles à l\'arrière de la cuisse qui fléchissent le genou. Souvent prélevés pour reconstruire le LCA. Leur renforcement est essentiel pour protéger le greffon en limitant le déplacement antérieur du tibia.',
    related: ['greffon', 'quadriceps'],
  },
  {
  ...
  },
  {
    ...
    full: 'Range of motion. Mesurée en degrés, elle indique la mobilité d\'une articulation. Pour le genou : extension complète = 0°, flexion complète ≈ 140°. La récupération de l\'amplitude est un objectif prioritaire des 6 premières semaines post-opératoires.',
    related: ['extension', 'flexion'],
  },
  {
    id: 'extension', term: 'Extension',
    category: 'Mouvement', phase: 'early',
    short: 'Le fait de tendre le genou complètement.',
    full: 'Mouvement de tendre l\'articulation. Pour le genou, c\'est aller de 90° (plié) vers 0° (tendu). L\'extension complète et symétrique est essentielle avant de penser à la course.',
    related: ['flexion', 'amplitude'],
  },
  {
    id: 'flexion', term: 'Flexion',
    category: 'Mouvement', phase: 'early',
    short: 'Le fait de plier le genou.',
    full: 'Mouvement opposé à l\'extension : plier le genou. Récupérer 130° de flexion permet de retrouver les escaliers, le vélo et l\'accroupissement.',
  ...
  },
  {
    ...
    full: 'Méthode d\'entraînement utilisant le cycle étirement-raccourcissement (ressort musculaire). Réintroduite en phase tardive de rééducation pour préparer le retour au sport. Exemples : sauts en boîte, foulées bondissantes.',
  ...
  },
  {
    ...
    category: 'Pathologie', phase: 'early',
    short: 'Accumulation de liquide dans le genou.',
    full: 'Présence anormale de liquide synovial ou de sang dans l\'articulation. Provoque gonflement et limitation de la mobilité. Glace, compression et élévation aident à le résorber. Un épanchement persistant inhibe le quadriceps.',
    related: ['quadriceps'],
  },
];
